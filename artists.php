...
<main id="main">
  ...
  <section class="shell pb-16" style="padding-top:calc(var(--header-h) + 5rem)">
    <p class="label-xs text-muted flex items-center gap-3 mb-6" data-reveal="right">
      <span class="num">02</span><span class="w-8 h-px bg-line"></span>Represented
    </p>
    ...
    <div class="flex flex-wrap gap-x-8 gap-y-3 mt-12 pt-8 rule-t label-xs text-muted" data-reveal="up">
  ...
  <section class="bg-paper py-20 sm:py-28">
    <div class="shell grid lg:grid-cols-12 gap-10">
      <div class="lg:col-span-5">
        <p class="label-xs text-muted mb-6" data-reveal="right">Submissions</p>
        <h2 class="display d-1 text-ink" data-split="lines" data-reveal="fade">We look twice a year</h2>
      </div>
      <div class="lg:col-span-7">
        <p class="text-muted leading-relaxed max-w-[58ch]" data-reveal="up">
        ...
        <div class="flex flex-wrap gap-3 mt-8" data-reveal="up" data-reveal-delay="120">
          <a href="mailto:<?= e(EMAIL) ?>?subject=Submission" class="btn"><span>Email a submission</span></a>
          <a href="<?= e(wa_link('Hello Nuqta, I would like to ask about submitting work for review.')) ?>" target="_blank" rel="noopener" class="btn btn-ghost"><span>Ask a question first</span></a>
        </div>
      </div>
    </div>
  </section>
