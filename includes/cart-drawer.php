...
<aside class="drawer" aria-hidden="true" aria-label="Enquiry list">
  ...
  <div class="flex items-center justify-between gap-4 px-6 py-5 rule-b">
    <div>
      ...
      <p class="label-xs text-paper-500 mt-2" data-cart-count-text>Empty</p>
    </div>
  ...
  <div class="px-6 py-5 rule-t bg-ink-850" data-cart-filled-toggle hidden>
    <div class="flex items-baseline justify-between gap-4">
      <span class="label-xs text-paper-500">Indicative total</span>
      <span class="num display d-3 text-brass-500" data-cart-total>₨ 0</span>
    </div>
    <p class="text-xs text-paper-500 mt-2 leading-relaxed">Nothing is charged here. Send the list and we reply with availability, framing and delivery.</p>
    <div class="grid gap-2.5 mt-5">
      <a class="btn" href="<?= e(wa_link()) ?>" target="_blank" rel="noopener" data-wa-enquiry data-no-veil>
        <span>
