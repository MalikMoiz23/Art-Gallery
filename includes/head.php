...
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' fill='%23DFE0DB'/%3E%3Ccircle cx='16' cy='16' r='6' fill='%23282A25'/%3E%3C/svg%3E">
...
<a href="#main" class="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[110] focus:bg-char focus:text-white focus:px-4 focus:py-2">Skip to content</a>
