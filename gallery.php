...
<main id="main">
  ...
  <section class="shell pb-14" style="padding-top:calc(var(--header-h) + 5rem)">
    <p class="label-xs text-brass-600 flex items-center gap-3 mb-6" data-reveal="right">
      <span class="num">01</span><span class="w-8 h-px bg-brass-600/50"></span>The collection
    </p>
  ...
  <!-- ======================================================= toolbar -->
  <section class="sticky z-40 bg-ink-950/88 backdrop-blur-xl rule-t rule-b" style="top:var(--header-h)">
    <div class="shell py-4">
      <div class="flex flex-col gap-4">

        <div class="flex flex-wrap items-center gap-3">
          <div class="relative flex-1 min-w-[200px] max-w-sm">
            <svg class="absolute left-0 top-1/2 -translate-y-1/2 text-paper-500" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" aria-hidden="true">
              <circle cx="11" cy="11" r="7"/><path d="m20 20-3.5-3.5"/>
            </svg>
            <input type="search" data-search placeholder="Search title, artist, medium…"
                   aria-label="Search the collection"
                   class="w-full bg-transparent border-0 border-b border-b-[var(--hair-strong)] focus:border-b-brass-500 outline-none py-2.5 pl-6 text-sm placeholder:text-paper-500 rounded-none transition-colors">
          </div>

          <div class="flex items-center gap-3 ml-auto">
            <span class="label-xs text-brass-500 num whitespace-nowrap" data-result-count><?= count($works) ?> works</span>
            <label class="label-xs text-paper-500 flex items-center gap-2">
              <span class="hidden sm:inline">Sort</span>
              <select data-sort aria-label="Sort the collection"
                      class="bg-transparent border border-[var(--hair)] rounded-none px-3 py-2 text-xs text-paper-200 outline-none focus:border-brass-500 cursor-pointer transition-colors">
        ...
        <div class="flex gap-3 overflow-x-auto pb-1 -mb-1" style="scrollbar-width:none">
  ...
  <section class="shell py-14 sm:py-20">
    ...
    <div data-grid-empty hidden class="py-24 text-center">
      ...
      <a href="<?= e(wa_link('Hello Nuqta, I am looking for a particular kind of work. Can you help?')) ?>" target="_blank" rel="noopener" class="btn mt-8" data-no-veil><span>Tell us what you want</span></a>
    </div>
  </section>
  ...
  <section class="shell pb-24 sm:pb-32">
    <div class="grid sm:grid-cols-3 gap-8 pt-10 rule-t" data-reveal-group="90">
      <div data-reveal="up">
        <p class="label-xs text-brass-600 mb-3">Prices are prices</p>
      ...
      <div data-reveal="up">
        <p class="label-xs text-brass-600 mb-3">Seven-day hold</p>
      ...
      <div data-reveal="up">
        <p class="label-xs text-brass-600 mb-3">Fourteen-day return</p>
