...
<main id="main">
  ...
  <section class="shell pb-12" style="padding-top:calc(var(--header-h) + 5rem)">
    <p class="label-xs text-brass-600 flex items-center gap-3 mb-6" data-reveal="right">
      <span class="num">05</span><span class="w-8 h-px bg-brass-600/50"></span>Enquiry list
    </p>
    ...
    <div class="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
      ...
      <div class="lg:col-span-7">
        <div class="flex items-baseline justify-between gap-4 pb-4 rule-b">
          <span class="label-xs text-paper-500" data-cart-count-text>Empty</span>
          <button type="button" class="label-xs text-paper-500 hover:text-clay-500 transition-colors" data-cart-clear data-cart-filled-toggle hidden>Clear the list</button>
        </div>
      ...
      <aside class="lg:col-span-5 lg:sticky" style="top:calc(var(--header-h) + 1.5rem)" data-cart-filled-toggle hidden>
        <div class="rule-t rule-b bg-ink-850 p-7 sm:p-8">
          <div class="flex items-baseline justify-between gap-4">
            <span class="label-xs text-paper-500">Indicative total</span>
            <span class="display d-2 num text-brass-500" data-cart-total>₨ 0</span>
          </div>
